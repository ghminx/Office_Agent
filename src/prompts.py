...
- **견적서-신규고객**: 완성된 견적서 파일을 첨부하여 클라이언트에게 전달하는 메일-신규고객 용도
  - 예: "견적서 작성 완료됐으니 메일로 보내줘 신규고객이야"
  
- **견적서-기존고객**: 완성된 견적서 파일을 첨부하여 클라이언트에게 전달하는 메일-기존고객 용도
  - 예: "견적서 작성 완료됐으니 메일로 보내줘 기존고객이야"
